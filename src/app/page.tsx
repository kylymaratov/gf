...
export const metadata: Metadata = {
  title: "General - Интернет-магазин качественных товаров",
  description: "General - современный интернет-магазин с широким ассортиментом качественных товаров по доступным ценам. Быстрая доставка, гарантия качества, удобная оплата.",
  keywords: "интернет-магазин, товары, доставка, качество, General",
  openGraph: {
    title: "General - Интернет-магазин качественных товаров",
